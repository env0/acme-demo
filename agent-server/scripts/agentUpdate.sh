...
helm repo update
helm update --create-namespace env0-agent env0/env0-agent --namespace env0-agent -f ~/values.yaml -f ~/customer-values.yaml --set storageClassName=local-path --kubeconfig=/etc/rancher/k3s/k3s.yaml
