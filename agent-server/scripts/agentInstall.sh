...
helm repo update
helm install --create-namespace env0-agent env0/env0-agent --namespace env0-agent -f values.yaml --set storageClassName=local-path --kubeconfig=/etc/rancher/k3s/k3s.yaml
